# UI Training Master Repository

Welcome to the UI Training repository. This project contains multiple learning modules demonstrating modern web development techniques, from pure HTML/CSS to advanced React state management and microservice architecture.
...
- **Icons**: React Icons (Phosphor, Phosphor, etc.)
