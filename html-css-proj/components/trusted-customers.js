    ...
    this.innerHTML = `
      <section class="Trusted-customer lean-section">
        ...
        <div class="container mb-5">
          <div class="flexitems">
            <div class="flexitem d-none d-lg-block d-xl-block d-md-block">
              <img src="./assets/customer-logo-1.png" />
            </div>
            <div class="flexitem d-none d-lg-block d-xl-block">
              <img src="./assets/customer-logo-2.png" />
            </div>
            <div class="flexitem d-none d-lg-block d-xl-block d-md-block">
              <img src="./assets/customer-logo-3.png" />
            </div>
            <div class="flexitem"><img src="./assets/customer-logo-4.png" /></div>
            <div class="flexitem d-none d-lg-block d-xl-block">
              <img src="./assets/customer-logo-5.png" />
            </div>
            <div class="flexitem d-none d-lg-block d-xl-block lst-img">
